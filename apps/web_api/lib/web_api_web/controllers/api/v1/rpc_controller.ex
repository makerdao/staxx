defmodule Staxx.WebApiWeb.Api.V1.RpcController do
  ...
  @doc false
  def handle(conn, %{"id" => id, "method" => "UnregisterDeployment", "data" => data}) do
  ...
  @doc false
  def handle(conn, %{"id" => id, "method" => "UpdateResult", "data" => data}) do
  ...
  @doc false
  def handle(conn, %{"method" => "RunResult", "data" => data}) do
  ...
  @doc false
  def handle(conn, %{"id" => id, "method" => method, "data" => data}) do
  ...
  def handle(conn, %{"method" => "CheckoutResult", "data" => data}) do
    id = Map.get(data, "id")
