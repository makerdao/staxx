defmodule Staxx.ExChain.Application do
  ...
  def start(_type, _args) do
    ...
    children = [
      Staxx.ExChain.BackendProxyNodeConnector,
      Staxx.ExChain.EVM.Supervisor,
      {Registry, keys: :unique, name: Staxx.ExChain.EVM.Registry},
      Staxx.ExChain.PortReserver,
      Staxx.ExChain.SnapshotManager,
