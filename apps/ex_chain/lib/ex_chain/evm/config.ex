defmodule Staxx.ExChain.EVM.Config do
  @moduledoc """
  ...
  - `network_id` - Network ID (Default: `Application.get_env(:ex_chain, :default_chain_id)`)
  ...
  @type t :: %__MODULE__{
          type: ExChain.evm_type(),
          id: ExChain.evm_id() | nil,
