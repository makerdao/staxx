defmodule Staxx.ExChain.EVM.Notification do
  @moduledoc """
  ...
  ```elixir
  %Staxx.ExChain.EVM.Notification{
  ...
  @doc """
  Just creating new `Staxx.ExChain.EVM.Notification` structure
  """
  @spec new(ExChain.evm_id(), atom(), term()) :: :ok
  ...
  """
  @spec send(%{notify_pid: pid()} | pid | module, ExChain.evm_id(), atom(), term()) :: :ok
...
defimpl Jason.Encoder, for: Staxx.ExChain.EVM.Notification do
