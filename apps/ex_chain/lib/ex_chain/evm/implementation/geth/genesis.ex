defmodule Staxx.ExChain.EVM.Implementation.Geth.Genesis do
  ...
  **Address with balance as tuple**
  ...
  Example:
  ```elixir
  iex> alias Staxx.ExChain.EVM.Implementation.Geth.Genesis
  Staxx.ExChain.EVM.Implementation.Geth.Genesis
