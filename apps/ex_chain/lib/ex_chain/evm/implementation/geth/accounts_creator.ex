defmodule Staxx.ExChain.EVM.Implementation.Geth.AccountsCreator do
  @moduledoc """
  Module handles all work related to accounts creation for geth
  """
  alias Staxx.ExChain.EVM.Account
  alias Staxx.ExChain.EVM.Implementation.Geth
  ...
  Example:
  ```elixir
  iex(1)> Staxx.ExChain.EVM.Implementation.Geth.AccountsCreator.create("/path/to/chain/data/dir")
  {:ok,
    %Staxx.ExChain.EVM.Account{
  ...
  def password_file(), do: Application.get_env(:ex_chain, :geth_password_file)
