defmodule Staxx.ExChain.EVM.Implementation.Ganache do
  @moduledoc """
  ...
  @impl EVM
  def get_ports() do
    port = PortReserver.new_unused_port()
    {port, port}
  end
  ...
  @impl EVM
  def executable!(), do: Application.get_env(:ex_chain, :ganache_executable)
  ...
  Example:
  ```elixir
  iex()> Staxx.ExChain.EVM.Implementation.Ganache.exec_command(8545, "eth_blockNumber")
