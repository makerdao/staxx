defmodule Staxx.Testchain.EVM.Implementation.Geth.Genesis do
  @moduledoc """
  ...
  **Address with balance as tuple**
  ...
  Example:
  ```elixir
  iex> alias Staxx.Testchain.EVM.Implementation.Geth.Genesis
  Staxx.Testchain.EVM.Implementation.Geth.Genesis
