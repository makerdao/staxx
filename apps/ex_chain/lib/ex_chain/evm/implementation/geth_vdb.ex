defmodule Staxx.ExChain.EVM.Implementation.GethVDB do
  @moduledoc """
  ...
  """
  use Staxx.ExChain.EVM

  alias Staxx.ExChain.EVM
  alias Staxx.ExChain.EVM.Config
  alias Staxx.ExChain.EVM.Account
  alias Staxx.ExChain.AccountStore
  alias Staxx.ExChain.EVM.Implementation.Geth.Genesis
  alias Staxx.ExChain.EVM.Implementation.Geth.AccountsCreator
  ...
  @impl EVM
  def executable!(),
    do: Application.get_env(:ex_chain, :geth_vdb_executable)
  ...
  """
  @spec start_node(Config.t(), [Account.t()]) :: Porcelain.Process.t()
  ...
  Example:
  ```elixir
  iex()> Staxx.ExChain.EVM.Implementation.Geth.exec_command(8545, "eth_blockNumber")
  {:ok, 80}
  ```
  """
