defmodule Staxx.ExChain.BackendProxyNodeConnector do
  @moduledoc """
  ...
  defp backend_node(), do: Application.get_env(:ex_chain, :backend_proxy_node)

  # Timeout generation for reconnect
  defp timeout(),
    do: Application.get_env(:ex_chain, :backend_proxy_node_reconnection_timeout, 10_000)
end
